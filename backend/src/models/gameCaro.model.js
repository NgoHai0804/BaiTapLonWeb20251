...
const GameCaroSchema = new Schema({
  ...
  roomId: { type: Schema.Types.ObjectId, ref: 'Room', index: true }, // ID phòngs
  playerX: { type: Schema.Types.ObjectId, ref: 'User' }, // Người chơi X
  playerO: { type: Schema.Types.ObjectId, ref: 'User' }, // Người chơi O
  winnerId: { type: Schema.Types.ObjectId, ref: 'User', default: null }, // Ngươi thắng
  boardSize: { type: Number, default: 15 }, // Size bàn
  startedAt: { type: Date, default: Date.now }, // Thời gian bắt đầu
  endedAt: { type: Date, default: null }, // Thời gan kết thúc
  mode: { type: String, enum: ['P2P','P2B'], default: 'P2P' }, // Loại chời người vs người, người vs bot
