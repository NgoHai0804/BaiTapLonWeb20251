...
const UserSchema = new Schema({
  ...
  nickname: { type: String }, // Tên hiển thị
  avatarUrl: { type: String }, // Avatar
  status: { type: String, enum: ['offline','online','in_game', 'banned'], default: 'offline', index: true }, // Trạng thái hđ
  
  gameStats: { type: [GameStatSchema], default: [] },

  createdAt: { type: Date, default: Date.now }, // Thời gian tạo tài khoản
  lastOnline: { type: Date } // Thời gian online
});
